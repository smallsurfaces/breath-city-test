    ...
    cityExamples: [
      ...
      },
      {
        ...
        chartData: { type: "sourceDonut", segments: [
          ...
          { label: "Waste burning", icon: "\u{1F5D1}\u{FE0F}", value: 18 },
          { label: "Other", icon: "\u{1F4CA}", value: 15 },
        ]},
      },
      {
  ...
  // Domain 3 — Health Impact Assessment
  {
    ...
    cityExamples: [
      ...
      },
      {
        citySlug: "bangkok",
        provenance: "BC Partnership",
        interventionName: "PM2.5 health crisis — school closures and child exposure tracking",
        introducedYear: 2019,
        outcomeState: "measured",
        outcomeNote: "97 exceedance days in 2023",
        chartData: { type: "coverageRing", label: "of 2023, children breathed unhealthy air", value: 70, unit: "%" },
      },
      {
        citySlug: "london",
        provenance: "City Achievement",
  ...
  // Domain 12 — Open Data Platform
  {
    ...
    cityExamples: [
      ...
      },
      {
        ...
        chartData: { type: "deltaBar", label: "Public monitoring stations", before: 4, after: 20, unit: "stations", change: "+400%" },
      },
    ],
    ...
    cityExamples: [
      ...
      },
      {
        ...
        chartData: {
          ...
          peers: [
            { flag: "\u{1F1EE}\u{1F1E9}", name: "Jakarta", label: "Sensor scaling 2023" },
            { flag: "\u{1F1FB}\u{1F1F3}", name: "Hanoi", label: "PM2.5 response 2024" },
          ],
        },
      },
    ],
