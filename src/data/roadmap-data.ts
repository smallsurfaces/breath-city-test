    ...
    cityExamples: [
      {
        ...
        chartData: { type: "sourceDonut", segments: [
          ...
          { label: "Industry", icon: "\u{1F3ED}", value: 20 },
          { label: "Other", icon: "\u{1F4CA}", value: 15 },
        ]},
      },
      {
        citySlug: "accra",
        ...
        chartData: { type: "sourceDonut", segments: [
          { label: "Household fuels", icon: "\u{1F525}", value: 40 },
          { label: "Waste burning", icon: "\u{1F5D1}\u{FE0F}", value: 25 },
          { label: "Vehicles", icon: "\u{1F697}", value: 20 },
          { label: "Other", icon: "\u{1F4CA}", value: 15 },
        ]},
      },
      {
        ...
        chartData: { type: "sourceDonut", segments: [
          ...
          { label: "Other sources", icon: "\u{1F4CA}", value: 25 },
        ]},
      },
    ],
    ...
    cityExamples: [
      {
        citySlug: "paris",
        provenance: "City Achievement",
        interventionName: "Airparif UFP epidemiological study programme",
        introducedYear: 2018,
        outcomeState: "measured",
        ...
        chartData: { type: "sparkline", label: "Respiratory admissions vs UFP levels", values: [45, 52, 60, 55, 48, 42, 38, 35, 32, 30], years: "2015–2024", change: "-33%" },
      },
      {
        citySlug: "jakarta",
        provenance: "BC Partnership",
        interventionName: "AQ-health vulnerability mapping & early warning system",
        introducedYear: 2022,
        outcomeState: "baseline-established",
        outcomeNote: "2022",
        chartData: { type: "coverageRing", label: "Districts with health-AQ mapping", value: 65, unit: "%" },
      },
      {
        citySlug: "london",
        provenance: "City Achievement",
        interventionName: "Air quality and health burden assessment — GLA",
        introducedYear: 2015,
        outcomeState: "measured",
        outcomeBefore: "4,300 premature deaths/year attributed to NO₂ and PM2.5",
        outcomeAfter: "Declined to est. 3,600 after ULEZ and LEZ interventions",
        outcomeChange: "-16%",
        chartData: { type: "deltaBar", label: "Premature deaths/year", before: 4300, after: 3600, unit: "deaths", change: "-16%" },
      },
    ],
    ...
    cityExamples: [
      {
        ...
        outcomeAfter: "200+ stations, real-time public API, open downloads",
        outcomeChange: "200+ stations",
        chartData: { type: "sparkline", label: "Active monitoring stations", values: [30, 42, 55, 68, 80, 95, 110, 130, 155, 175, 200], years: "2005–2024", change: "+570%" },
      },
      {
        citySlug: "jakarta",
        provenance: "City Achievement",
      ...
      },
      {
        ...
        outcomeAfter: "Real-time public dashboard with 15 stations",
        outcomeChange: "15 stations live",
        chartData: { type: "deltaBar", label: "Public monitoring stations", before: 4, after: 15, unit: "stations", change: "+275%" },
      },
    ],
  ...
  // Domain 8 — Raising Awareness & Community Engagement
  {
    ...
    cityExamples: [
      ...
      },
      {
        citySlug: "jakarta",
        provenance: "BC Partnership",
        interventionName: "AQ crisis awareness to community monitoring",
        introducedYear: 2019,
        outcomeState: "measured",
        outcomeChange: "35% now AQ-aware",
        chartData: {
          type: "awarenessTimeline",
          metric: "Population aware of AQ issues",
          startYear: 2017,
          ...
          campaigns: [
            { num: 1, year: 2019, label: "AQ crisis — social media surge" },
            { num: 2, year: 2021, label: "udara.jakarta.go.id dashboard" },
            { num: 3, year: 2022, label: "Community monitoring programme" },
          ],
        },
      },
      {
