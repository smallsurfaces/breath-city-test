 ...
 *   CoverageMatrix.tsx (commit 09839c6 / tag wireframe-lock-2026-05-26). Internal links
 *   rewritten to /visual-concepts/best-practice-roadmap-v1/ routes. Forked so visual evolution
 *   stays isolated from the wireframe-locked UX concept. First-deploy render identical.
 *
                ...
                {DOMAINS.map((domain, idx) => {
                  ...
                  return (
                    <TableCell key={domain.id} className="text-center px-1">
                      {active ? (
                        <Link
                          href={`/visual-concepts/best-practice-roadmap-v1/domain/${domain.slug}#${city.slug}`}
