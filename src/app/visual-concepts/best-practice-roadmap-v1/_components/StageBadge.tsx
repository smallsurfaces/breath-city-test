/**
 * StageBadge.tsx — roadmap stage badge for the Visual Concept v1 sandbox.
 *
 * Fork origin: clean fork of src/app/ux-concepts/best-practice-roadmap-v2/_components/
 *   StageBadge.tsx (commit 09839c6 / tag wireframe-lock-2026-05-26). Forked so visual evolution
