/**
 * page.tsx — Cities index page, /visual-concepts/best-practice-roadmap-v1/cities.
 *
 * Fork origin
 *   Clean fork of src/app/ux-concepts/best-practice-roadmap-v2/cities/page.tsx (commit 09839c6 /
 *   tag wireframe-lock-2026-05-26). Internal city-card links rewritten to point at the
 *   /visual-concepts/best-practice-roadmap-v1/city/[slug] routes so the visual concept is fully
 *   self-contained. First-deploy render identical to v2; visual evolution happens here only.
 *
 * Purpose (carried forward from v2)
 *   The cities listing page. SAME structure, content, data, and interactions as the v1 cities
 *   page. The differences vs the original v1 are skin-level:
        ...
        <div className="mx-auto grid max-w-4xl grid-cols-1 gap-5 sm:grid-cols-2 lg:grid-cols-3">
          {CITIES.map((city) => {
            ...
            return (
              <Link
                key={city.slug}
                href={`/visual-concepts/best-practice-roadmap-v1/city/${city.slug}`}
