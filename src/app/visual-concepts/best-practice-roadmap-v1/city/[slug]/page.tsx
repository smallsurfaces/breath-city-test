/**
 * page.tsx — City detail page, /visual-concepts/best-practice-roadmap-v1/city/[slug].
 *
 * Fork origin
 *   Clean fork of src/app/ux-concepts/best-practice-roadmap-v2/city/[slug]/page.tsx (commit
 *   09839c6 / tag wireframe-lock-2026-05-26). Internal breadcrumb and "also active in" links
 *   rewritten to /visual-concepts/best-practice-roadmap-v1 routes so the visual concept is
 *   fully self-contained. First-deploy render identical to v2.
 *
 * Purpose (carried forward from v2)
 *   The city detail page. SAME structure, content, data, and interactions as the v1 city detail
 *   page. The differences vs the original v1 are skin-level: internal breadcrumb and domain
 *   badge links target the synchronised concept's own routes.
 *
 * Key exports: default page component, generateStaticParams, generateMetadata
 * External dependencies: @/data/roadmap-data, shadcn Badge, local _components (CityMapHero,
 *   PracticeCardTile)
 */
...
export async function generateMetadata({
  ...
  return {
    title: city
      ? `${city.name} — BC AQ Roadmap (Visual Concept V1)`
      : 'City — BC AQ Roadmap (Visual Concept V1)',
  }
}
