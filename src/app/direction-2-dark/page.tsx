"use client";
import { direction2Dark, applyTheme } from "@/themes";
...
const swatches = [
  { label: "Background", hex: "#001f47" },
  { label: "Foreground", hex: "#ffffff" },
  { label: "Primary", hex: "#23bced" },
  { label: "Secondary", hex: "#e8f000", darkText: true },
  { label: "Accent", hex: "#2bcdb0" },
  { label: "Destructive", hex: "#ff6633" },
];

export default function Page() {
  return (
    <div style={{ ...applyTheme(direction2Dark), backgroundColor: "hsl(var(--background))", color: "hsl(var(--foreground))", minHeight: "100vh" }}>
      <DirectionHeader directionName="Direction 02 — Open Sky" mode="dark" fontLabel="Söhne — var(--bc-font-family-sans)" fontFamily="var(--bc-font-family-sans)" swatches={swatches} />
