...
export const ATLAS_CITIES: AtlasCity[] = [
  ...
  { id: 'addis-ababa', slug: 'addis-ababa', name: 'Addis Ababa', country: 'Ethiopia', lat: 9.0054, lng: 38.7636, hasChapter: false, missionLine: 'Addis Ababa is expanding cycling lanes and air quality sensors to see where pollution hits hardest.', cardImage: bcImage('2026/06/Addis.png'), tier: null },
  { id: 'bangkok', slug: 'bangkok', name: 'Bangkok', country: 'Thailand', lat: 13.7563, lng: 100.5018, hasChapter: false, missionLine: 'Bangkok is shaping a stronger Low Emission Zone and bringing community-led air quality monitoring to high-risk areas.', cardImage: bcImage('2025/07/Country-cards-65.png'), tier: null },
  { id: 'bogota', slug: 'bogota', name: 'Bogotá', country: 'Colombia', lat: 4.711, lng: -74.0721, hasChapter: true, missionLine: 'Bogotá is bringing clean air zones to the southwestern neighbourhoods that carry the heaviest burden of polluted air.', cardImage: bcImage('2024/09/Bogota-e1728988673808.png'), tier: 4 },
  ...
  { id: 'mexico-city', slug: 'mexico-city', name: 'Mexico City', country: 'Mexico', lat: 19.4326, lng: -99.1332, hasChapter: true, missionLine: 'Mexico City is bringing neighbourhood-level air quality data to community hubs to protect the people most exposed.', cardImage: bcImage('2025/07/Country-cards-66.png'), tier: 3 },
  ...
  { id: 'nairobi', slug: 'nairobi', name: 'Nairobi', country: 'Kenya', lat: -1.2921, lng: 36.8219, hasChapter: false, missionLine: 'Nairobi runs its own network of air quality sensors, using the data to find hotspots and guide action.', cardImage: bcImage('2025/07/card-cities-nairobi.png'), tier: null },
