"use client";
import { direction3Light, applyTheme } from "@/themes";
...
const swatches = [
  { label: "Background", hex: "#f4f7fc" },
  { label: "Foreground", hex: "#00214d", darkText: true },
  { label: "Primary", hex: "#0071c7" },
  { label: "Secondary", hex: "#1a7d6c" },
  { label: "Accent", hex: "#0f83a6" },
  { label: "Destructive", hex: "#f55200" },
];

export default function Page() {
  return (
    <div style={{ ...applyTheme(direction3Light), backgroundColor: "hsl(var(--background))", color: "hsl(var(--foreground))", minHeight: "100vh" }}>
      <DirectionHeader directionName="Direction 03 — Civic Depth" mode="light" fontLabel="Söhne + Aeonik Mono" fontFamily="var(--bc-font-family-sans)" monoFamily="var(--bc-font-family-mono)" swatches={swatches} />
