...
const DIR3_VARS: Record<string, string> = {
  "--background":             "216 100% 17%",
  "--foreground":             "0 0% 100%",
  "--primary":                "210 100% 39%",
  "--primary-foreground":     "0 0% 100%",
  "--secondary":              "185 66% 49%",
  "--secondary-foreground":   "216 100% 10%",
  "--muted":                  "216 100% 22%",
  "--muted-foreground":       "215 30% 65%",
  "--accent":                 "194 84% 53%",
  "--accent-foreground":      "216 100% 10%",
...
const SWATCHES: { token: string; label: string; hex: string }[] = [
  { token: "--background",  label: "Background",  hex: "#00205a" },
  { token: "--foreground",  label: "Foreground",  hex: "#ffffff" },
  { token: "--primary",     label: "Primary",     hex: "#0071c7" },
  { token: "--secondary",   label: "Secondary",   hex: "#23bced" },
  { token: "--accent",      label: "Accent",      hex: "#1cd6f5" },
...
export default function Direction3Page() {
  const wrapperStyle = Object.fromEntries(
    Object.entries(DIR3_VARS).map(([k, v]) => [k, v])
  ...
  const radius     = "var(--radius, 0.25rem)"
  const sans       = "var(--bc-font-family-sans, sans-serif)"
  const mono       = "var(--bc-font-family-mono, monospace)"
  ...
  return (
    ...
    >
      ...
      >
        <div style={{ maxWidth: "1080px", margin: "0 auto" }}>
          ...
          >
            ...
            >
              Heading — Söhne · var(--bc-font-family-sans)
              &nbsp;&nbsp;|&nbsp;&nbsp;
              Body — Aeonik Mono · var(--bc-font-family-mono)
            </p>
            ...
            <p style={{ fontFamily: mono, fontSize: "0.6rem", color: mutedFg, marginBottom: "1rem" }}>
              H1 · 2.25rem · Bold 700 · Söhne (sans)
            </p>
            ...
            <p style={{ fontFamily: mono, fontSize: "0.6rem", color: mutedFg, marginBottom: "1rem" }}>
              Body · 1rem · Regular 400 · Aeonik Mono
            </p>
            ...
            <p style={{ fontFamily: mono, fontSize: "0.6rem", color: mutedFg }}>
              Caption/Data · 0.75rem · Regular 400 · Aeonik Mono
            </p>
          </div>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "repeat(6, 1fr)", gap: "0.75rem" }}>
            {SWATCHES.map((s) => (
              <div key={s.token}>
                ...
                />
                <p style={{ fontFamily: mono, fontSize: "0.6rem", fontWeight: 600, color: foreground }}>
                  {s.label}
                </p>
                <p style={{ fontFamily: mono, fontSize: "0.55rem", color: mutedFg }}>{s.hex}</p>
              </div>
            ))}
          </div>
        </div>
      ...
      <div style={{ maxWidth: "1080px", margin: "0 auto", padding: "0 2rem 4rem" }}>
        ...
        >
          <span style={{ fontFamily: sans, fontSize: "1rem", fontWeight: 700, color: primary }}>
            Breathe Cities
          </span>
        ...
        <div style={{ marginBottom: "2rem" }}>
          <p style={{ fontFamily: mono, fontSize: "0.75rem", color: mutedFg, marginBottom: "0.5rem" }}>
          ...
          >
            <h1 style={{ fontFamily: sans, fontSize: "2.5rem", fontWeight: 700, lineHeight: 1, color: foreground }}>
              Vienna
            </h1>
            <span style={{ fontFamily: mono, fontSize: "1rem", lineHeight: 2, color: mutedFg }}>
              Austria 🇦🇹
            </span>
          </div>
          ...
          >
            ...
            <div>
              <p style={{ fontFamily: sans, fontSize: "1.25rem", fontWeight: 700, color: "#03ab3d" }}>Good</p>
              <p style={{ fontFamily: mono, fontSize: "0.75rem", color: mutedFg }}>AQI (US)</p>
            </div>
          </div>
          ...
          <p style={{ fontFamily: mono, fontSize: "0.8rem", color: mutedFg, marginBottom: "0.25rem" }}>
            Main pollutant: PM2.5
          </p>
          <p style={{ fontFamily: mono, fontSize: "0.75rem", color: mutedFg, marginBottom: "1rem" }}>
        ...
        >
          ...
          <div>
            ...
            <p style={{ fontFamily: mono, fontSize: "0.875rem", color: foreground }}>
        ...
        <div style={{ marginBottom: "2rem" }}>
          ...
          >
            ...
            <p style={{ fontFamily: mono, fontSize: "0.7rem", color: mutedFg, margin: 0 }}>
              ...
              <Table>
                <TableHeader>
                  <TableRow style={{ borderBottomColor: border }}>
                    <TableHead style={{ fontFamily: mono, color: mutedFg, fontSize: "0.75rem" }}>Station</TableHead>
                    <TableHead style={{ fontFamily: mono, color: mutedFg, fontSize: "0.75rem" }}>District</TableHead>
                    <TableHead style={{ fontFamily: mono, color: mutedFg, fontSize: "0.75rem" }}>AQI</TableHead>
                    <TableHead style={{ fontFamily: mono, color: mutedFg, fontSize: "0.75rem" }}>Status</TableHead>
                  </TableRow>
                </TableHeader>
                <TableBody>
                  {MAP_RANKINGS.map((st) => (
                    <TableRow key={st.name} style={{ borderBottomColor: border }}>
                      <TableCell style={{ fontFamily: mono, color: cardFg, fontSize: "0.8rem" }}>
                        {st.name}
                      </TableCell>
                      <TableCell style={{ fontFamily: mono, color: mutedFg, fontSize: "0.8rem" }}>
                        {st.district}
                      </TableCell>
                      <TableCell style={{ fontFamily: mono, color: cardFg, fontSize: "0.8rem" }}>
                        {st.aqi}
        ...
        <Tabs defaultValue="today" style={{ marginBottom: "2rem" }}>
              ...
              <CardContent style={{ padding: "1.5rem" }}>
                <div style={{ display: "flex", alignItems: "flex-end", gap: "1rem", height: "120px" }}>
                  {FORECAST.map((f) => (
                    ...
                    >
                      <p style={{ fontFamily: mono, fontSize: "0.65rem", color: mutedFg }}>
                        {f.aqi}
                      </p>
                      <div
                        style={{
          ...
          <TabsContent value="3day">
            <Card style={{ backgroundColor: card, border: `1px solid ${border}` }}>
              <CardContent style={{ padding: "1.5rem" }}>
                <p style={{ fontFamily: mono, color: mutedFg, fontSize: "0.875rem" }}>3-day forecast data</p>
              </CardContent>
            </Card>
          </TabsContent>
          <TabsContent value="7day">
            <Card style={{ backgroundColor: card, border: `1px solid ${border}` }}>
              <CardContent style={{ padding: "1.5rem" }}>
                <p style={{ fontFamily: mono, color: mutedFg, fontSize: "0.875rem" }}>7-day forecast data</p>
              </CardContent>
            </Card>
          </TabsContent>
        </Tabs>
        ...
        <Card style={{ backgroundColor: card, border: `1px solid ${border}`, marginBottom: "2rem" }}>
          <Table>
            <TableHeader>
              <TableRow style={{ borderBottomColor: border }}>
                <TableHead style={{ fontFamily: mono, color: mutedFg }}>Station</TableHead>
                <TableHead style={{ fontFamily: mono, color: mutedFg }}>AQI</TableHead>
                <TableHead style={{ fontFamily: mono, color: mutedFg }}>Status</TableHead>
              </TableRow>
            </TableHeader>
            <TableBody>
              {STATIONS.map((st) => (
                <TableRow key={st.name} style={{ borderBottomColor: border }}>
                  <TableCell style={{ fontFamily: mono, color: cardFg }}>{st.name}</TableCell>
                  <TableCell style={{ fontFamily: mono, color: cardFg }}>{st.aqi}</TableCell>
                  <TableCell>
                    <Badge
                      style={{
                        fontFamily: mono,
        ...
        >
          <p style={{ fontFamily: mono, fontSize: "0.75rem", color: mutedFg }}>
