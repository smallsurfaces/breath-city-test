 ...
 *
 * Purpose
 *   The shared hero block: a small uppercase brand-blue eyebrow, a single h1 headline, a muted
 *   lead paragraph, and an optional children slot beneath (for hero-adjacent content the page
 *   wants directly under the lead). Extracted from the AQ Network homepage header
 ...
 *   - Eyebrow: brand blue, set inline as `var(--bc-color-blue)` (the reference's `text-bc-blue`,
 *     converted to the robust inline-token mechanism per the project styling convention).
...
type ConceptHeroProps = {
  /** Small uppercase eyebrow above the headline (brand blue). */
  eyebrow: string
...
/**
 * The hero block. Renders the eyebrow → h1 → lead, then the optional children slot. The h1 size
 * is fixed at text-3xl/sm:text-4xl (the cap); colour comes from bridged semantics + one inline
 * brand-blue eyebrow token.
 */
